  ...
  return (
    ...
    >
      ...
      <p className="font-share mt-32 text-center">
        This agreement is entered into on_____________ between the following
        parties:
      </p>
      ...
      {collaborators.map((collaborator, index) => (
        <p key={index} className="font-share pt-2 pl-20">
          ...
          <div className="flex items-center space-x-2">
            ...
            <div className="w-32 border-b-2 border-black">
              {collaborator.typeOfcontribution}
            </div>
          </div>
          <div className="flex items-center space-x-2">
...
export default UnsignedSongWriter
